...
// fetch photo
  ...
  static dynamic getEstimation(int id)async{
    ...
    try {
      ...
      var response = await client.get(Uri.parse("$addWorkApi$id"),
      headers: headers);
...
// user profile
  ...
  static uploadWork({required int id,
    ...
    required String qty, required String price,
    ...
    try {
      var headers = {
        'Authorization': 'Bearer $accessToken',
        'Cookie': 'XSRF-TOKEN=%3D; epm_session=%3D'
      };
